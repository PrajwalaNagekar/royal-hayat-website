...
export const departments: Department[] = [
  {
    id: 1, icon: Heart, category: "Women's Health",
  ...
  {
    id: 2, icon: Heart, category: "Women's Health",
  ...
  {
    id: 3, icon: Baby, category: "Children",
  ...
  {
    id: 4, icon: Baby, category: "Children",
  ...
  {
    id: 5, icon: Activity, category: "General",
  ...
  {
    id: 6, icon: Scissors, category: "Surgery",
  ...
  {
    id: 7, icon: Scissors, category: "Cosmetic",
  ...
  {
    id: 9, icon: Stethoscope, category: "Head & Neck",
  ...
  {
    id: 10, icon: Activity, category: "General",
  ...
  {
    id: 11, icon: Smile, category: "Dental",
  ...
  {
    id: 13, icon: Stethoscope, category: "Surgery",
  ...
  {
    id: 14, icon: AlertCircle, category: "Emergency",
    ...
    descAr: "مراقبة ورعاقبة على مدار الساعة للحالات الحرجة المهددة للحياة.",
    img: "https://res.cloudinary.com/dwhc8kzpv/image/upload/q_auto/f_auto/v1776342130/1_lc2cxx.jpg",
  },
  {
    id: 15, icon: Microscope, category: "Diagnostics",
  ...
  {
    id: 16, icon: Microscope, category: "Diagnostics",
  ...
  {
    id: 17, icon: Pill, category: "Pharmacy",
  ...
  {
    id: 18, icon: Home, category: "Wellness",
  ...
  {
    id: 20, icon: Pill, category: "Pharmacy",
...
export const deptDoctorAliases: Record<string, string[]> = {
  ...
  "Plastic Surgery": ["La Cosmetique", "Plastic Surgery"],
  ...
  "Plastic & Cosmetic Surgery": ["La Cosmetique", "Plastic Surgery", "Plastic & Cosmetic Surgery"],
