...
export const departmentDetails: DepartmentDetail[] = [
  ...
  },
  {
    ...
    intro: "Royale Home Health is an exclusive extension of Royale Hayat Hospital, offering exceptional health and wellness support delivered directly to your home. Our services blend high-quality medical care with the signature luxury and hospitality of Royale Hayat.",
    sections: [
      {
        title: "Personalized Home Care",
        content: "Backed by a multi-disciplinary team of healthcare professionals, we provide personalized, compassionate, and expert care aligned with the highest international standards.",
      },
      {
        title: "Rehabilitation Services",
        items: [
          "Cardiac and Stroke rehabilitation",
          "Back pain and Musculoskeletal management",
