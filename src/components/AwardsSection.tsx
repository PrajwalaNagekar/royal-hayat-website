...
const awards = [
  { image: serviceHero, name: "16th Service Hero Award", nameAr: "جائزة بطل الخدمة السادسة عشرة", year: "2010–2025", source: "Service Hero Index", sourceAr: "مؤشر بطل الخدمة", desc: "Best Hospital in Kuwait for 16 consecutive years.", descAr: "أفضل مستشفى في الكويت لمدة 16 عامًا متتاليًا.", stat: "16", statLabel: "Consecutive Years", statLabelAr: "سنة متتالية" },
